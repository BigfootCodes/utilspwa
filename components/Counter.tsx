  ...
  return (
    <div className="flex flex-col min-h-full max-w-md mx-auto relative px-6 py-12">
      ...
      <section className="flex-1 flex flex-col items-center justify-center relative">
        <div className="bg-[#e2e2e5] dark:bg-[#252828]/80 backdrop-blur-3xl border border-[#c1c8c8] dark:border-[#444747]/50 rounded-[3rem] p-8 w-full aspect-square flex flex-col items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.2)] relative overflow-hidden group">
          ...
          <motion.div 
            ...
            className="text-[120px] leading-[1] font-bold text-[#001618] dark:text-[#f0f0f3] tracking-tighter select-none tabular-nums z-10 transition-transform duration-300 transform group-active:scale-95"
          >
      ...
      <section className="mt-12 pb-32 flex flex-col gap-8 w-full items-center">
        <div className="flex items-center justify-center gap-4 w-full max-w-[320px]">
          ...
          <button 
            onClick={increment}
            className="w-24 h-24 rounded-full bg-[#0d2c2e] dark:bg-[#0d2c2e] text-white shadow-[0_8px_30px_rgba(13,44,46,0.3)] dark:shadow-[0_8px_30px_rgba(13,44,46,0.5)] flex items-center justify-center hover:opacity-90 active:scale-95 transition-all duration-200"
          >
            <Plus size={40} />
          </button>
        </div>
